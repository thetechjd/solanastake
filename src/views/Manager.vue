<template>
  ...
  <div v-else>
    <div class="flex mb-10 w-full justify-center">
      <button class="nes-btn is-primary mr-5" @click="showNewFarm = !showNewFarm">
        New farm
      </button>
    ...
    <div v-if="foundFarms && foundFarms.length">
      ...
      <!--manage NFT types-->
      <TheWhitelist :key="farmAcc.bank" :farm="farm" :bank="farmAcc.bank.toBase58()" class="mb-10" />
      <!--manage funders-->
      <AuthorizeFunder :key="farm" :farm="farm" class="mb-10" />
      <!--manage funding-->
      <FundCancelLock :farm="farm" :farmAcc="farmAcc" class="mb-10" @update-farm="handleUpdateFarm" />
      <!--refresh farmer-->
